...
import com.cuichuang.common.bean.Bean1;
import com.cuichuang.common.bean.Bean2;
import com.cuichuang.common.bean.Bean3;
...
public interface ApiServer {
     ...
     */
    @FormUrlEncoded
    @POST("index/public_login")
    Observable<BaseModel<LoginBean>> getLoginInfo(@FieldMap HashMap<String, String> params);
    /**
     * 第一种写法
     *
     * @param requestType
...
//    Observable<BaseModel<List<MainBean>>> getMain2(@Field("time") String requestType);
     ...
     */
//    @POST("api/Activity/get_activities?")
//    Observable<com.cuichuang.common.base.view.BaseModel<List<Bean1>, Bean2, List<Bean3>>> getMain2Demo(@Query("time") String requestType);
...
//    @FormUrlEncoded
//    @POST("api/Activity/get_activities?")
//    Observable<com.cuichuang.common.base.view.BaseModel<List<Bean1>, Bean2, List<Bean3>>> getMain3Demo(@FieldMap HashMap<String, String> params);
